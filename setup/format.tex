...
% 调整罗列环境的布局
\setitemize{leftmargin=1em,itemsep=0em,partopsep=0em,parsep=0em,topsep=-0em}
\setenumerate{leftmargin=1em,itemsep=0em,partopsep=0em,parsep=0em,topsep=0em}
...
%\cleardoublepage%
   \phantomsection
    ...
    \begin{titlepage}
      ...
      \vspace*{1cm}
      {\bfseries\erhao\bfseries{\@ctitle}}
      \vspace*{1cm}
...
\chapter*{\centering\erhao{\bfseries\song 摘\qquad 要}}
\setcounter{page}{1}
\song\defaultfont
\@cabstract
\vspace{\baselineskip}
