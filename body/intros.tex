...
这个版本是在原作者: prayever@gmail.com(张井)，lantaoyu1991@gmail.com(余蓝涛)的基础上进行了部分格式的调整和少量内容补充。
...
\section{下载安装}
旧版本目前有三个访问途径：
TJUThesis~主页：~\url{http://tjuthesis.googlecode.com/}。但该镜像目前似乎已不可用。
另外两个已知可用资源地址为人大经济论坛，以及CSDN。\\
修正补充版地址：~\url{http://www.github.com/6gbluewind/}。
\section{目录内容}
